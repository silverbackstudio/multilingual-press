...
use Inpsyde\MultilingualPress\Core\PluginProperties;

defined( 'ABSPATH' ) or die();

require __DIR__ . '/vendor/autoload.php';

// TODO: Remove all things related to MLP_PLUGIN_FILE.
//define( 'MLP_PLUGIN_FILE', __FILE__ );

// TODO: Remove this (as there is no need for this anymore due to proper autoloading).
if ( ! class_exists( 'Multilingual_Press' ) ) {
	require plugin_dir_path( __FILE__ ) . 'src/_todo/Multilingual_Press.php';
}
...
function mlp_init() {
	...
	if ( ! class_exists( 'Mlp_Load_Controller' ) ) {
		require $plugin_path . 'src/_todo/autoload/Mlp_Load_Controller.php';
	}

	$loader = new Mlp_Load_Controller( $plugin_path . 'src/_todo' );

	$data = new PluginProperties();
 ...
 * @return bool
 */
function mlp_pre_run_test( $pagenow, Properties $data, $wp_version, wpdb $wpdb ) {
