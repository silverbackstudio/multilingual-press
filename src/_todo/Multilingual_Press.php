...
class Multilingual_Press {
	 ...
	 * @param wpdb $wpdb
	 */
	public function __construct( Properties $data, wpdb $wpdb = NULL ) {
	...
	public function setup() {
		 ...
		 *
		 * @param Properties $plugin_data Plugin data object.
	...
	protected function load_features() {
		...
		$path = $this->plugin_data->get( 'plugin_dir_path' ) . "/src/_todo";
